  ...
  module Messages
    ...
    class Reject < ::Protobuf::Message
      ...
      class RejectType < ::Protobuf::Enum
        ...
        AuthenticatorFail = value(:AuthenticatorFail, 8)
      end
    ...
    MessageAliases = {
      Version => :version,
      UDPTunnel => :udp_tunnel,
      Authenticate => :authenticate,
      Ping => :ping,
      Reject => :reject,
      ServerSync => :server_sync,
      ChannelRemove => :channel_remove,
      ...
      ContextActionModify => :context_action_modify,
      ContextAction => :context_action,
      UserList => :user_list,
      VoiceTarget => :voice_target,
      PermissionQuery => :permission_query,
